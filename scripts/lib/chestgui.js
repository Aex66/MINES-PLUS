...
export class ChestGui {
    ...
    setType(type) {
        ...
        const size = (_a = ChestGuiTypes[type]) !== null && _a !== void 0 ? _a : ChestGuiTypes['small'];
        for (let i = 0; i < size[1]; i++)
            this.formData.items.push({ data: '', icon: undefined });
        return this;
    }
    title(title) {
    ...
    item(slot, name, lore, icon, stackSize = 1, enchanted = false, enchants) {
        const ID = typeIdToID.get(icon.startsWith('minecraft:') ? icon : 'minecraft:' + icon);
        let enchantments = enchants === null || enchants === void 0 ? void 0 : enchants.map(e => `§7${beauty('minecraft:' + e.id)} ${toRomanNumeral(e.level)}`);
        //@ts-ignore
        this.formData.items.splice(slot, 1, { data: `stack#${Math.min(Math.max(stackSize, 1) || 1, 99).toString().padStart(2, '0')}§r${name !== null && name !== void 0 ? name : ''}§r${(enchantments === null || enchantments === void 0 ? void 0 : enchantments.length) ? `\n§r${enchantments.join('\n§r')}` : ''}§r${(lore === null || lore === void 0 ? void 0 : lore.length) ? `\n§r${lore.join('\n§r')}` : ''}`, icon: (((ID + (ID < 256 ? 0 : number)) * 65536) + (!!enchanted * 32768)) || icon });
        return this;
    }
    show(player) {
        var _a, _b, _c;
        //yEAh
        if (!((_a = this.formData) === null || _a === void 0 ? void 0 : _a.type) || !((_c = (_b = this.formData) === null || _b === void 0 ? void 0 : _b.items) === null || _c === void 0 ? void 0 : _c.length))
            throw Error('ChestGui is missing data!');
        const form = new ActionFormData();
        if (this.formData.title)
            form.title(ChestGuiTypes[this.formData.type][0] + this.formData.title);
        else
            form.title(ChestGuiTypes[this.formData.type][0]);
        this.formData.items.forEach((item) => { var _a; return form.button(item.data, (_a = item.icon) === null || _a === void 0 ? void 0 : _a.toString()); });
...
export const typeIdToID = new Map([
    ...
    ['minecraft:stick', 322],
    ['minecraft:bowl', 323],
    ['minecraft:golden_sword', 324],
    ['minecraft:golden_shovel', 325],
    ['minecraft:golden_pickaxe', 326],
    ['minecraft:golden_axe', 327],
    ['minecraft:string', 328],
    ['minecraft:feather', 329],
    ['minecraft:gunpowder', 330],
    ['minecraft:wooden_hoe', 331],
    ['minecraft:stone_hoe', 332],
    ['minecraft:iron_hoe', 333],
    ['minecraft:diamond_hoe', 334],
    ['minecraft:golden_hoe', 335],
    ['minecraft:wheat', 336],
    ['minecraft:leather_helmet', 337],
    ['minecraft:leather_chestplate', 338],
    ['minecraft:leather_leggings', 339],
    ['minecraft:leather_boots', 340],
    ['minecraft:chainmail_helmet', 341],
    ['minecraft:chainmail_chestplate', 342],
    ['minecraft:chainmail_leggings', 343],
    ['minecraft:chainmail_boots', 344],
    ['minecraft:iron_helmet', 345],
    ['minecraft:iron_chestplate', 346],
    ['minecraft:iron_leggings', 347],
    ['minecraft:iron_boots', 348],
    ['minecraft:diamond_helmet', 349],
    ['minecraft:diamond_chestplate', 350],
    ['minecraft:diamond_leggings', 351],
    ['minecraft:diamond_boots', 352],
    ['minecraft:golden_helmet', 353],
    ['minecraft:golden_chestplate', 354],
    ['minecraft:golden_leggings', 355],
    ['minecraft:golden_boots', 356],
    ['minecraft:shield', 357],
    ['minecraft:flint', 358],
    ['minecraft:painting', 359],
    ['minecraft:oak_sign', 360],
    ['minecraft:wooden_door', 361],
    ['minecraft:bucket', 362],
    ['minecraft:milk_bucket', 363],
    ['minecraft:water_bucket', 364],
    ['minecraft:lava_bucket', 365],
    ['minecraft:cod_bucket', 366],
    ['minecraft:salmon_bucket', 367],
    ['minecraft:tropical_fish_bucket', 368],
    ['minecraft:pufferfish_bucket', 369],
    ['minecraft:powder_snow_bucket', 370],
    ['minecraft:axolotl_bucket', 371],
    ['minecraft:minecart', 372],
    ['minecraft:saddle', 373],
    ['minecraft:iron_door', 374],
    ['minecraft:redstone', 375],
    ['minecraft:snowball', 376],
    ['minecraft:oak_boat', 377],
    ['minecraft:birch_boat', 378],
    ['minecraft:jungle_boat', 379],
    ['minecraft:spruce_boat', 380],
    ['minecraft:acacia_boat', 381],
    ['minecraft:dark_oak_boat', 382],
    ['minecraft:leather', 383],
    ['minecraft:kelp', 384],
    ['minecraft:brick', 385],
    ['minecraft:clay_ball', 386],
    ['minecraft:sugar_cane', 387],
    ['minecraft:paper', 388],
    ['minecraft:book', 389],
    ['minecraft:slime_ball', 390],
    ['minecraft:chest_minecart', 391],
    ['minecraft:egg', 392],
    ['minecraft:compass', 393],
    ['minecraft:fishing_rod', 394],
    ['minecraft:clock', 395],
    ['minecraft:glowstone_dust', 396],
    ['minecraft:black_dye', 397],
    ['minecraft:red_dye', 398],
    ['minecraft:green_dye', 399],
    ['minecraft:brown_dye', 400],
    ['minecraft:blue_dye', 401],
    ['minecraft:purple_dye', 402],
    ['minecraft:cyan_dye', 403],
    ['minecraft:light_gray_dye', 404],
    ['minecraft:gray_dye', 405],
    ['minecraft:pink_dye', 406],
    ['minecraft:lime_dye', 407],
    ['minecraft:yellow_dye', 408],
    ['minecraft:light_blue_dye', 409],
    ['minecraft:magenta_dye', 410],
    ['minecraft:orange_dye', 411],
    ['minecraft:white_dye', 412],
    ['minecraft:bone_meal', 413],
    ['minecraft:cocoa_beans', 414],
    ['minecraft:ink_sac', 415],
    ['minecraft:lapis_lazuli', 416],
    ['minecraft:bone', 417],
    ['minecraft:sugar', 418],
    ['minecraft:cake', 419],
    ['minecraft:bed', 420],
    ['minecraft:repeater', 421],
    ['minecraft:filled_map', 422],
    ['minecraft:shears', 423],
    ['minecraft:ender_pearl', 424],
    ['minecraft:blaze_rod', 425],
    ['minecraft:ghast_tear', 426],
    ['minecraft:gold_nugget', 427],
    ['minecraft:potion', 428],
    ['minecraft:glass_bottle', 429],
    ['minecraft:fermented_spider_eye', 430],
    ['minecraft:blaze_powder', 431],
    ['minecraft:magma_cream', 432],
    ['minecraft:brewing_stand', 433],
    ['minecraft:cauldron', 434],
    ['minecraft:ender_eye', 435],
    ['minecraft:glistering_melon_slice', 436],
    ['minecraft:chicken_spawn_egg', 437],
    ['minecraft:cow_spawn_egg', 438],
    ['minecraft:pig_spawn_egg', 439],
    ['minecraft:sheep_spawn_egg', 440],
    ['minecraft:wolf_spawn_egg', 441],
    ['minecraft:mooshroom_spawn_egg', 442],
    ['minecraft:creeper_spawn_egg', 443],
    ['minecraft:enderman_spawn_egg', 444],
    ['minecraft:silverfish_spawn_egg', 445],
    ['minecraft:skeleton_spawn_egg', 446],
    ['minecraft:slime_spawn_egg', 447],
    ['minecraft:spider_spawn_egg', 448],
    ['minecraft:zombie_spawn_egg', 449],
    ['minecraft:zombie_pigman_spawn_egg', 450],
    ['minecraft:villager_spawn_egg', 451],
    ['minecraft:squid_spawn_egg', 452],
    ['minecraft:ocelot_spawn_egg', 453],
    ['minecraft:witch_spawn_egg', 454],
    ['minecraft:bat_spawn_egg', 455],
    ['minecraft:ghast_spawn_egg', 456],
    ['minecraft:magma_cube_spawn_egg', 457],
    ['minecraft:blaze_spawn_egg', 458],
    ['minecraft:cave_spider_spawn_egg', 459],
    ['minecraft:horse_spawn_egg', 460],
    ['minecraft:rabbit_spawn_egg', 461],
    ['minecraft:endermite_spawn_egg', 462],
    ['minecraft:guardian_spawn_egg', 463],
    ['minecraft:stray_spawn_egg', 464],
    ['minecraft:husk_spawn_egg', 465],
    ['minecraft:wither_skeleton_spawn_egg', 466],
    ['minecraft:donkey_spawn_egg', 467],
    ['minecraft:mule_spawn_egg', 468],
    ['minecraft:skeleton_horse_spawn_egg', 469],
    ['minecraft:zombie_horse_spawn_egg', 470],
    ['minecraft:shulker_spawn_egg', 471],
    ['minecraft:npc_spawn_egg', 472],
    ['minecraft:elder_guardian_spawn_egg', 473],
    ['minecraft:polar_bear_spawn_egg', 474],
    ['minecraft:llama_spawn_egg', 475],
    ['minecraft:vindicator_spawn_egg', 476],
    ['minecraft:evoker_spawn_egg', 477],
    ['minecraft:vex_spawn_egg', 478],
    ['minecraft:zombie_villager_spawn_egg', 479],
    ['minecraft:parrot_spawn_egg', 480],
    ['minecraft:tropical_fish_spawn_egg', 481],
    ['minecraft:cod_spawn_egg', 482],
    ['minecraft:pufferfish_spawn_egg', 483],
    ['minecraft:salmon_spawn_egg', 484],
    ['minecraft:drowned_spawn_egg', 485],
    ['minecraft:dolphin_spawn_egg', 486],
    ['minecraft:turtle_spawn_egg', 487],
    ['minecraft:phantom_spawn_egg', 488],
    ['minecraft:agent_spawn_egg', 489],
    ['minecraft:cat_spawn_egg', 490],
    ['minecraft:panda_spawn_egg', 491],
    ['minecraft:fox_spawn_egg', 492],
    ['minecraft:pillager_spawn_egg', 493],
    ['minecraft:wandering_trader_spawn_egg', 494],
    ['minecraft:ravager_spawn_egg', 495],
    ['minecraft:bee_spawn_egg', 496],
    ['minecraft:strider_spawn_egg', 497],
    ['minecraft:hoglin_spawn_egg', 498],
    ['minecraft:piglin_spawn_egg', 499],
    ['minecraft:zoglin_spawn_egg', 500],
    ['minecraft:piglin_brute_spawn_egg', 501],
    ['minecraft:sniffer_spawn_egg', 502],
    ['minecraft:axolotl_spawn_egg', 503],
    ['minecraft:goat_spawn_egg', 504],
    ['minecraft:glow_squid_spawn_egg', 505],
    ['minecraft:iron_golem_spawn_egg', 506],
    ['minecraft:snow_golem_spawn_egg', 507],
    ['minecraft:ender_dragon_spawn_egg', 508],
    ['minecraft:wither_spawn_egg', 509],
    ['minecraft:glow_ink_sac', 510],
    ['minecraft:copper_ingot', 511],
    ['minecraft:raw_iron', 512],
    ['minecraft:raw_gold', 513],
    ['minecraft:raw_copper', 514],
    ['minecraft:experience_bottle', 515],
    ['minecraft:fire_charge', 516],
    ['minecraft:writable_book', 517],
    ['minecraft:written_book', 518],
    ['minecraft:emerald', 519],
    ['minecraft:frame', 520],
    ['minecraft:flower_pot', 521],
    ['minecraft:empty_map', 522],
    ['minecraft:skull', 523],
    ['minecraft:carrot_on_a_stick', 524],
    ['minecraft:nether_star', 525],
    ['minecraft:firework_rocket', 526],
    ['minecraft:firework_star', 527],
    ['minecraft:enchanted_book', 528],
    ['minecraft:comparator', 529],
    ['minecraft:netherbrick', 530],
    ['minecraft:quartz', 531],
    ['minecraft:tnt_minecart', 532],
    ['minecraft:hopper_minecart', 533],
    ['minecraft:hopper', 534],
    ['minecraft:rabbit_foot', 535],
    ['minecraft:rabbit_hide', 536],
    ['minecraft:leather_horse_armor', 537],
    ['minecraft:iron_horse_armor', 538],
    ['minecraft:golden_horse_armor', 539],
    ['minecraft:diamond_horse_armor', 540],
    ['minecraft:music_disc_13', 541],
    ['minecraft:music_disc_cat', 542],
    ['minecraft:music_disc_blocks', 543],
    ['minecraft:music_disc_chirp', 544],
    ['minecraft:music_disc_far', 545],
    ['minecraft:music_disc_mall', 546],
    ['minecraft:music_disc_mellohi', 547],
    ['minecraft:music_disc_stal', 548],
    ['minecraft:music_disc_strad', 549],
    ['minecraft:music_disc_ward', 550],
    ['minecraft:music_disc_11', 551],
    ['minecraft:music_disc_wait', 552],
    ['minecraft:trident', 553],
    ['minecraft:lead', 554],
    ['minecraft:name_tag', 555],
    ['minecraft:prismarine_crystals', 556],
    ['minecraft:mutton', 557],
    ['minecraft:cooked_mutton', 558],
    ['minecraft:armor_stand', 559],
    ['minecraft:spruce_door', 560],
    ['minecraft:birch_door', 561],
    ['minecraft:jungle_door', 562],
    ['minecraft:acacia_door', 563],
    ['minecraft:dark_oak_door', 564],
    ['minecraft:chorus_fruit', 565],
    ['minecraft:popped_chorus_fruit', 566],
    ['minecraft:dragon_breath', 567],
    ['minecraft:splash_potion', 568],
    ['minecraft:lingering_potion', 569],
    ['minecraft:command_block_minecart', 570],
    ['minecraft:elytra', 571],
    ['minecraft:prismarine_shard', 572],
    ['minecraft:shulker_shell', 573],
    ['minecraft:banner', 574],
    ['minecraft:totem_of_undying', 575],
    ['minecraft:iron_nugget', 576],
    ['minecraft:nautilus_shell', 577],
    ['minecraft:heart_of_the_sea', 578],
    ['minecraft:scute', 579],
    ['minecraft:turtle_helmet', 580],
    ['minecraft:phantom_membrane', 581],
    ['minecraft:crossbow', 582],
    ['minecraft:spruce_sign', 583],
    ['minecraft:birch_sign', 584],
    ['minecraft:jungle_sign', 585],
    ['minecraft:acacia_sign', 586],
    ['minecraft:dark_oak_sign', 587],
    ['minecraft:flower_banner_pattern', 588],
    ['minecraft:creeper_banner_pattern', 589],
    ['minecraft:skull_banner_pattern', 590],
    ['minecraft:mojang_banner_pattern', 591],
    ['minecraft:field_masoned_banner_pattern', 592],
    ['minecraft:bordure_indented_banner_pattern', 593],
    ['minecraft:piglin_banner_pattern', 594],
    ['minecraft:globe_banner_pattern', 595],
    ['minecraft:campfire', 596],
    ['minecraft:suspicious_stew', 597],
    ['minecraft:honeycomb', 598],
    ['minecraft:honey_bottle', 599],
    ['minecraft:camera', 600],
    ['minecraft:compound', 601],
    ['minecraft:ice_bomb', 602],
    ['minecraft:bleach', 603],
    ['minecraft:rapid_fertilizer', 604],
    ['minecraft:balloon', 605],
    ['minecraft:medicine', 606],
    ['minecraft:sparkler', 607],
    ['minecraft:glow_stick', 608],
    ['minecraft:lodestone_compass', 609],
    ['minecraft:netherite_sword', 610],
    ['minecraft:netherite_shovel', 611],
    ['minecraft:netherite_pickaxe', 612],
    ['minecraft:netherite_axe', 613],
    ['minecraft:netherite_hoe', 614],
    ['minecraft:netherite_ingot', 615],
    ['minecraft:netherite_helmet', 616],
    ['minecraft:netherite_chestplate', 617],
    ['minecraft:netherite_leggings', 618],
    ['minecraft:netherite_boots', 619],
    ['minecraft:netherite_scrap', 620],
    ['minecraft:crimson_sign', 621],
    ['minecraft:warped_sign', 622],
    ['minecraft:crimson_door', 623],
    ['minecraft:warped_door', 624],
    ['minecraft:warped_fungus_on_a_stick', 625],
    ['minecraft:chain', 626],
    ['minecraft:music_disc_pigstep', 627],
    ['minecraft:nether_sprouts', 628],
    ['minecraft:soul_campfire', 629],
    ['minecraft:glow_frame', 630],
    ['minecraft:amethyst_shard', 631],
    ['minecraft:spyglass', 632],
    ['minecraft:music_disc_otherside', 633],
    ['minecraft:goat_horn', 634],
    ['minecraft:frog_spawn_egg', 635],
    ['minecraft:tadpole_spawn_egg', 636],
    ['minecraft:tadpole_bucket', 637],
    ['minecraft:allay_spawn_egg', 638],
    ['minecraft:warden_spawn_egg', 639],
    ['minecraft:mangrove_door', 640],
    ['minecraft:mangrove_sign', 641],
    ['minecraft:mangrove_boat', 642],
    ['minecraft:music_disc_5', 643],
    ['minecraft:disc_fragment_5', 644],
    ['minecraft:oak_chest_boat', 645],
    ['minecraft:birch_chest_boat', 646],
    ['minecraft:jungle_chest_boat', 647],
    ['minecraft:spruce_chest_boat', 648],
    ['minecraft:acacia_chest_boat', 649],
    ['minecraft:dark_oak_chest_boat', 650],
    ['minecraft:mangrove_chest_boat', 651],
    ['minecraft:chest_boat', 652],
    ['minecraft:recovery_compass', 653],
    ['minecraft:echo_shard', 654],
    ['minecraft:trader_llama_spawn_egg', 655],
    ['minecraft:cherry_boat', 656],
    ['minecraft:cherry_chest_boat', 657],
    ['minecraft:cherry_sign', 658],
    ['minecraft:bamboo_sign', 659],
    ['minecraft:bamboo_raft', 660],
    ['minecraft:bamboo_chest_raft', 661],
    ['minecraft:camel_spawn_egg', 662],
    ['minecraft:angler_pottery_sherd', 663],
    ['minecraft:archer_pottery_sherd', 664],
    ['minecraft:arms_up_pottery_sherd', 665],
    ['minecraft:blade_pottery_sherd', 666],
    ['minecraft:brewer_pottery_sherd', 667],
    ['minecraft:burn_pottery_sherd', 668],
    ['minecraft:danger_pottery_sherd', 669],
    ['minecraft:explorer_pottery_sherd', 670],
    ['minecraft:friend_pottery_sherd', 671],
    ['minecraft:heart_pottery_sherd', 672],
    ['minecraft:heartbreak_pottery_sherd', 673],
    ['minecraft:howl_pottery_sherd', 674],
    ['minecraft:miner_pottery_sherd', 675],
    ['minecraft:mourner_pottery_sherd', 676],
    ['minecraft:plenty_pottery_sherd', 677],
    ['minecraft:prize_pottery_sherd', 678],
    ['minecraft:sheaf_pottery_sherd', 679],
    ['minecraft:shelter_pottery_sherd', 680],
    ['minecraft:skull_pottery_sherd', 681],
    ['minecraft:snort_pottery_sherd', 682],
    ['minecraft:brush', 683],
    ['minecraft:netherite_upgrade_smithing_template', 684],
    ['minecraft:sentry_armor_trim_smithing_template', 685],
    ['minecraft:dune_armor_trim_smithing_template', 686],
    ['minecraft:coast_armor_trim_smithing_template', 687],
    ['minecraft:wild_armor_trim_smithing_template', 688],
    ['minecraft:ward_armor_trim_smithing_template', 689],
    ['minecraft:eye_armor_trim_smithing_template', 690],
    ['minecraft:vex_armor_trim_smithing_template', 691],
    ['minecraft:tide_armor_trim_smithing_template', 692],
    ['minecraft:snout_armor_trim_smithing_template', 693],
    ['minecraft:rib_armor_trim_smithing_template', 694],
    ['minecraft:spire_armor_trim_smithing_template', 695],
    ['minecraft:silence_armor_trim_smithing_template', 696],
    ['minecraft:wayfinder_armor_trim_smithing_template', 697],
    ['minecraft:raiser_armor_trim_smithing_template', 698],
    ['minecraft:shaper_armor_trim_smithing_template', 699],
    ['minecraft:host_armor_trim_smithing_template', 700],
    ['minecraft:music_disc_relic', 701],
    ['minecraft:terracotta', 702],
    ['minecraft:wool', 703],
    ['minecraft:carpet', 704],
    ['minecraft:log', 705],
    ['minecraft:fence', 706],
    ['minecraft:coral', 707],
    ['minecraft:log2', 708],
    ['minecraft:concrete', 709],
    ['minecraft:concrete_powder', 710],
    ['minecraft:stained_glass', 711],
    ['minecraft:stained_glass_pane', 712],
    ['minecraft:dyed_shulker_box', 713],
    ['minecraft:boat', 714],
    ['minecraft:dye', 715],
    ['minecraft:banner_pattern', 716],
    ['minecraft:spawn_egg', 717],
    ['minecraft:end_crystal', 718],
    ['minecraft:glow_berries', 719]
]);
